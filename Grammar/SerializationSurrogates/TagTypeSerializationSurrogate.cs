...
{
	/// <summary>
	/// <see cref="TagType"/> serialization surrogate for replacing deserialized
	...
	/// </summary>
	public class TagTypeSerializationSurrogate : ISerializationSurrogate
	{
		...
		public void GetObjectData(object obj, SerializationInfo info, StreamingContext context)
		{
			...
			var tagType = (TagType)obj;

			info.AddValue("key", tagType.Key);
		}
		...
		public object SetObjectData(object obj, SerializationInfo info, StreamingContext context, ISurrogateSelector selector)
		{
			...
			try
			{
				...
				return grammarModel.TagTypes[inflectionTypeKey];
			}
